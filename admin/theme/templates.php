...
<link href="<?php echo web_root; ?>admin/css/ekko-lightbox.css" rel="stylesheet">
  ...
  <?php
    $query = "SELECT * FROM summary WHERE ORDEREDSTATS = 'Pending'";
    $mydb->setQuery($query);
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >Jihed E-Commerce</a>
            </div>
            <!-- /.navbar-header -->
...
<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>admin/js/Jihed.js"></script> 
  ...
  format: 'mm/dd/yyyy',
    ...
    forceParse: 0,
     changeMonth: true,
      ...
      <footer><p  style="text-align: center;font-weight: bold;">Copyright &copy; Jihed Ben Othmen </p></footer>
</html>