          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +216 50 701 969</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> jihed0405@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="social-icons pull-right">
              <ul class="nav navbar-nav">
                <li><a href="https://www.facebook.com/profile.php?id=100013854373327"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                <li><a href="https://www.linkedin.com/in/jihed-ben-othmen-5b6abb190/"><i class="fa fa-linkedin"></i></a></li>
                <li><a href="#"><i class="fa fa-dribbble"></i></a></li>
                <li><a href="https://jihed0405@gmail.com"><i class="fa fa-google-plus"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              ...
              <p>I'm Nicer when i like my outfit</p>
            </div>
          </div>
         
         
          <div class="col-sm-3" style="margin-left:50%">
            <div class="address">
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                 <?php 
                      $mydb->setQuery("SELECT * FROM `category` LIMIT 6");
                      $cur = $mydb->loadResultList();
                     foreach ($cur as $result) {
                      echo '<li><a href="index.php?q=product&category='.$result->CATEGORIES.'" >'.$result->CATEGORIES.'</a></li>';
                      }
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          ...
          <p class="pull-right">Designed by <span><a target="_blank" href="https://github.com/Jihed0405">Jihed Ben Othmen</a></span></p>
        </div>
      </div>
    </div>
...
<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>js/jihed.js"></script> 
 <script type="text/javascript">
