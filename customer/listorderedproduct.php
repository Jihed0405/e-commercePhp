		...
		<h5>As you have ordered cash on pick up, please have the exact amount of cash to pay to our staff and bring this billing details.</h5>
		 ...
		 <div class="row">
		 	<!-- <div class="col-md-6">
		 		...
		 		<?php 
		 			$query="SELECT sum(ORDEREDQTY) as 'countitem' FROM `order` WHERE `ORDEREDNUM`='".$_SESSION['ordernumber']."'";
		 			$mydb->setQuery($query);
		...
		<table id="table" class="table">
			<thead>
				...
				<?php
				 $subtot=0;
				  $query = "SELECT * 
							FROM  `product` p, category ct,  `customer` c,  `order` o,  `summary` s
		...
		?>
 		...
 		<div class="row">
		  ...
		  <div class="row">
		  	  ...
		  	  <p>Sincerely.</p>
		  	  <h4><a href="https://bit.ly/2LPn9Wu">Jihed Source Code</a></h4>
		  </div>
		  <?php }?>
  </div> 
